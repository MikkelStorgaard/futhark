...
class internal
{
    ...
    */
    ...
    (int, byte[], int) futhark_main(long a_mem_sizze_2488, byte[] a_mem_2489,
                                    int sizze_2479)
    {
        var binop_x_2491 = sext_i32_i64(sizze_2479);
        var bytes_2490 = (binop_x_2491 * Convert.ToInt64(4));
        var mem_2492 = allocateMem(bytes_2490);
        var i_2484 = Convert.ToInt32(0);
        var one_2502 = Convert.ToInt32(1);
        foreach (var counter_2501 in Enumerable.Range(0, sizze_2479))
        {
            var binop_param_noncurried_2482 = indexArray<int>(a_mem_2489,
                                                              (i_2484 * Convert.ToInt32(4)),
                                                              BitConverter.ToInt32);
            var res_2483 = (binop_param_noncurried_2482 + Convert.ToInt32(2));
            writeScalarArray(mem_2492, (i_2484 * Convert.ToInt32(4)),
                             Convert.ToInt32(res_2483));
            i_2484 += one_2502;
        }
        var out_arrsizze_2499 = sizze_2479;
        var out_memsizze_2498 = bytes_2490;
        var out_mem_2497 = mem_2492;
        return (out_memsizze_2498, out_mem_2497, out_arrsizze_2499);
    }
    FileStream runtime_file = null;
    var do_warmup_run = false;
    var num_runs = 1;
